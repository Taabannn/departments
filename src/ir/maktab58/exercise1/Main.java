...
public class Main {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        findClerksInEachDepartment(departments, clerks);
        ...
        while (isThisUserAllowed(userAndPass)) {
            ...
            if (choice.equals("1")) {
                ...
                departments = updateDepartmentInfo(departmentAccess, departments, inputLine);
    ...
    public static ArrayList<Department> updateDepartmentInfo(DepartmentDataBaseAccess departmentAccess, ArrayList<Department> departments,
                                                             Scanner inputLine) throws SQLException {
        ...
        int result = departmentAccess.updateDepartment(department, newDepartmentName);
        if (result == 1)
            System.out.println("This item is updated successfully.");
        else
            System.out.println("Sorry! New Changes are discarded. Please try again.");
    ...
    public static void findClerksInEachDepartment(ArrayList<Department> departments, ArrayList<Clerk> clerks){
        for (Department department: departments)
            for (Clerk clerk: clerks)
